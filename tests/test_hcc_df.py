...
data = {0: [['L988', 'Z96653', 'L97429', 'B351', 'L97419', 'M109'], 80, 'F', 'CNA', 1, False], 
        1: [['L84', 'B351', 'M109', 'M2041','D8687','E083211'], 72, 'M', 'INS', 0, False],
        2: [['D122', 'M25473', 'D6859', 'F13181'], 65, 'M', 'CPD', 0, True],
       }

df = pd.DataFrame.from_dict(data,orient='index',columns=['dx_lst', 'age', 'sex', 'elig', 'orec', 'medicaid'])
...
def test_run_hcc(he_28):
    ...
    assert all(set(a) == set(b) for a, b in zip(df1['hcc_lst'], df2['hcc_lst'])),'the generated hcc_lst is not the same'